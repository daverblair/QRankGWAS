...
pheno_file=~/Desktop/MendelianDiseaseProject/Analysis/Section_4/QRankGWAS/QRankDatasets/GBR/OMIM_ICD_108_QRankData.txt
...
output_prefix=~/Desktop/MendelianDiseaseProject/QRankGWAS/Debug/tmp_hht_testsnps
